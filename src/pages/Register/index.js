    ...
    <>
      <Stack className="bg-gray_50 font-montserrat xl:h-[1013px] 2xl:h-[1139px] 3xl:h-[1367px] lg:h-[810px] mx-[auto] pl-[1px] w-[100%]">
        ...
        <Column className="absolute justify-start left-[10%] top-[4%] w-[37%]">
          ...
          ></SelectBox>
          <FloatingInput
            className="bg-transparent placeholder:bg-white_A700 border-0 font-medium placeholder:left-[33px] text-[20px] placeholder:text-gray_401 text-gray_401 placeholder:top-[0] top-[0] tracking-ls02 w-[100%]"
            name="Group1383"
            labelClasses="bg-white_A700 left-[33px] top-[0] text-gray_401"
          ...
          ></FloatingInput>
          <FloatingInput
            className="bg-transparent placeholder:bg-white_A700 border-0 font-medium placeholder:left-[35px] text-[20px] placeholder:text-gray_401 text-gray_401 placeholder:top-[0] top-[0] tracking-ls02 w-[100%]"
            name="Group1381"
