    ...
    <>
      <Stack className="bg-gray_50 font-montserrat 3xl:h-[1198px] lg:h-[709px] xl:h-[887px] 2xl:h-[998px] mx-[auto] w-[100%]">
        <Column className="absolute inset-x-[0] justify-start mx-[auto] top-[4%] w-[81%]">
          ...
          />
          <Text
            className="lg:ml-[131px] xl:ml-[164px] 2xl:ml-[185px] 3xl:ml-[222px] xl:mt-[106px] 2xl:mt-[120px] 3xl:mt-[144px] lg:mt-[85px] text-gray_901 w-[auto]"
            as="h2"
            variant="h2"
          >
          ...
          <Column className="items-center justify-start lg:mt-[184px] xl:mt-[231px] 2xl:mt-[260px] 3xl:mt-[312px] w-[100%]">
            <Column className="justify-start w-[100%]">
              <Row className="items-start w-[94%]">
                ...
                />
                <Text
                  className="font-bold lg:ml-[254px] xl:ml-[318px] 2xl:ml-[358px] 3xl:ml-[429px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[7px] xl:mt-[9px] text-gray_901 w-[auto]"
                  as="h6"
                  variant="h6"
                >
                  Secciones
                ...
                <Text
                  className="font-bold xl:ml-[119px] 2xl:ml-[134px] 3xl:ml-[160px] lg:ml-[95px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[7px] xl:mt-[9px] text-gray_901 w-[auto]"
                  as="h6"
                  variant="h6"
                >
                  Redes sociales
...
export default DesktopOneOnePage;
